...
//JMG #include <EtherCard.h> //nanode lib
#include <Arduino.h> // Arduino 1.0 required for boolean type definition
...
const int chipSelect = 9; //JMG SS PIN for SD SPI
...
void loop () {
  ...
  //JMG nanodeUpdate(); //checking for received data
